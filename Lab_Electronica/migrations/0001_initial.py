...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Lab_Electronica_category', (
            ('id_category', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'Lab_Electronica', ['Category'])

        # Adding model 'Component'
        db.create_table(u'Lab_Electronica_component', (
            ('id_component', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('note', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('total', self.gf('django.db.models.fields.IntegerField')()),
            ('available', self.gf('django.db.models.fields.IntegerField')()),
            ('id_category_fk', self.gf('django.db.models.fields.related.ForeignKey')(related_name='category', to=orm['Lab_Electronica.Category'])),
        ))
        db.send_create_signal(u'Lab_Electronica', ['Component'])

        # Adding model 'DetailCart'
        db.create_table(u'Lab_Electronica_detailcart', (
            ('id_student_fk', self.gf('django.db.models.fields.related.ForeignKey')(related_name='student_cart', to=orm['LabsIndex.Student'])),
            ('id_component_fk', self.gf('django.db.models.fields.related.ForeignKey')(related_name='component_cart', to=orm['Lab_Electronica.Component'])),
            ...
            ('date_checkout', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('id_cart', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'Lab_Electronica', ['DetailCart'])

        # Adding model 'DetailHistory'
        db.create_table(u'Lab_Electronica_detailhistory', (
            ('id_student_fk', self.gf('django.db.models.fields.related.ForeignKey')(related_name='student_history', to=orm['LabsIndex.Student'])),
            ('id_component_fk', self.gf('django.db.models.fields.related.ForeignKey')(related_name='component_history', to=orm['Lab_Electronica.Component'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')()),
            ('date_out', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_in', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('id_history', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'Lab_Electronica', ['DetailHistory'])


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table(u'Lab_Electronica_category')

        # Deleting model 'Component'
        db.delete_table(u'Lab_Electronica_component')

        # Deleting model 'DetailCart'
        db.delete_table(u'Lab_Electronica_detailcart')

        # Deleting model 'DetailHistory'
        db.delete_table(u'Lab_Electronica_detailhistory')
